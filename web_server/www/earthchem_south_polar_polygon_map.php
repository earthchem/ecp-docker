...
?>
        ...
        <h1 id="title">EarthChem South Polar Polygon Map</h1><br>
		...
		<table>
			<tr>
				<td>
					...
					<input type="hidden" id="polarpolygon" name="polarpolygon">
        ...
        <script type="text/javascript">
            var map, vectors, controls;
				...
				function newPolygonAdded (evt) {
						...
						document.getElementById('polarpolygon').value = coordlist;
				...
				function clearpoly(){
					...
					document.getElementById('polarpolygon').value = "";				
