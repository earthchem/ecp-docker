...
$rocknames=$db->get_results("select distinct(data4) as rockname from raw_rock_translation where lower(data4) like '".$rockname."%' and data1='vein' order by rockname limit 10");
