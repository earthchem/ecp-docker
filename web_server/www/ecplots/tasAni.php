...
include ("/var/www/jpgraph/jpgraph.php"); // jpgraph driver
include ("/var/www/jpgraph/jpgraph_scatter.php"); // jpgraph scatter plot
...
if($db->num_rows==0){
	echo "No samples found suitable for TAS animation. Please try another query.";
	echo '
...
$success2 = system("chmod -R 777  \"/var/www/plots/$basedir\"  "); //echo "<p>chmod directory $basedir ? $success ";
...
exec(" cp /var/www/plots/$image_filename /var/www/plots/$basedir/movie_last_frame.jpg",$foo,$bar); // Copy the last frame
...
echo '<p />The movie plays on an embedded player. You can also play an <a href="http://hopper.kgs.ku.edu/plots/'.$basedir.'/newout.avi">AVI movie</a>.</div>'; // Offer the AVI version to click on, too
...
if ($earthchem) {
// Per Jason Kerstin wants HTML buttons, not images    echo '<input style="margin-left:10px" name="submit" type="image" value="submit" src="images/ec_animate.gif" alt="Animate" align="right" hspace="0" vspace="0" border="0" >';
