...
$mycoords=$db->get_var("select polarpolygon from search_query where pkey=$pkey");
...
//-8200000 -8200000 8200000 8200000
...
$oMap = ms_newMapObj("polarbathy.map");
...
if($_GET['BBOX'] != "" ){
	...
	$mybox="-8200000, -8200000, 8200000, 8200000";
}
